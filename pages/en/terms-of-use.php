...
<p>While we are proud of the services we provide to the world for free and try to make them reliable and useful, we make no promises about them. All web services are certain to fail some of the time. We adapt and change our services from time to time, so you may find that something that worked for you may cease to work. We may also stop supplying any service, temporarily or permanently or block access to our services to anyone for any reason.</p>
<p>If you need some guarantee of a particular service level, then please do not hesitate to contact us to discuss whether we could offer you a commercial version of any of our services (assuming one is not available).</p>
<p>We are not a professional weather service and nothing we do is intended to be taken as an advice. In particular:</p>
<ul>
<li>Our forecast are the raw results of a coarse numerical simulation. Weather is something complex, unknown, and evolving fast. We, or anybody else, can make absolutly no warranty regarding the accuracy or usability of the data we provide. This data must not be used in any way where it can be harmful to life, goods or revenue.</li>

</ul>
<h3><span id="what-you-agree">What you agree</span></h3>
<p>You agree not to use our websites to do any of the following:</p>
<ul>
...
<p>Our most important class of account is one you may create in order to become a community member (ie: on our forum and wiki). By registering as a community member, you are acknowledging your connection to us. You are subject to any rules for community members we may publish and we may send you email messages we think appropriate for members, for example in order to poll you on some important issue.</p>
<p>Community membership is not membership in the formal sense of membership of a not-for-profit organization.</p>
<h3><span id="content-and-intellectual-property">Content and intellectual property</span></h3>
...
<p>As a general rule, this agreement will not change the ownership of any intellectual property belonging to either party. Where your content is used by us or vice versa both you and we would do so under a licence (see above).</p>
...
<h4><span id="this-agreement">This agreement</span></h4>
